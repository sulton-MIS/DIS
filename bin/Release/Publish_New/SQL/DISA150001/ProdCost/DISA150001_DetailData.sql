...
--SELECT 
--	ROW_NUMBER() OVER (ORDER BY A.[Dmc_Type] ASC) ROW_NUM
--	,A.[Dmc_Type] as ID 
--	,B.kategori as KATEGORI_MATERIAL
--	,A.[Dmc_Type]
--	,[Customer]
--	,[Lot_Size]
...
--    ,[CT_Konpo]
--FROM 
--	ad_dis_pc_production_cost_summary A
--JOIN
--	ad_dis_pc_production_cost_detail B
--ON
--	A.Dmc_Type = B.Dmc_Type
--WHERE 
--	A.[Dmc_Type] = @ID
