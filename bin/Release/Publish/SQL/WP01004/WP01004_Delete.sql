...
EXEC SP_INSERT_UPDATE_LOG_H @USERNAME,'','WP01004',1,'1','DELETE',@@COUNTER;
...
IF NOT EXISTS (SELECT 1
					FROM TB_R_WP_DETAIL_WORKING WHERE ID_TB_M_WORKING_TYPE = @ID)
BEGIN
	DELETE TB_M_WORKING_TYPE WHERE ID_TB_M_WORKING_TYPE = @ID
	SELECT 'True' AS MSG;
	DECLARE @@MSG_SUCCESS VARCHAR(MAX) = 'MWP002 : '+ (SELECT dbo.GenerateMessage('MWP002','WORKING TYPE','',''));
...
@USERNAME,'','WP01004','1',1,'DELETE',@@COUNTER;
