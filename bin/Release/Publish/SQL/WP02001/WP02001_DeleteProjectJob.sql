...
EXEC SP_INSERT_UPDATE_LOG_H @USERNAME,'','WP02001',1,'1','DELETE',@@COUNTER;
...
BEGIN TRY
	...
	DELETE TB_R_WP_PROJECT_JOB WHERE ID = @ID

	DECLARE @@MSG_SUCCESS VARCHAR(MAX) = 'MWP002 : '+ (SELECT dbo.GenerateMessage('MWP002','DETAIL ACTIVITY PROJECT','',''));
...
@USERNAME,'','WP02001','1',1,'DELETE',@@COUNTER;