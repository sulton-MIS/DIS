...
EXEC SP_INSERT_UPDATE_LOG_H @USERNAME,'','WP01006',1,'1','DELETE',@@COUNTER;
...
IF NOT EXISTS (SELECT 1
					FROM TB_R_WP_DETAIL_IMPLEMENTOR WHERE ID_TB_M_COMPANY = @ID)
BEGIN
	DELETE TB_M_COMPANY WHERE ID_TB_M_COMPANY = @ID;
	SELECT 'True' AS MSG;
...
BEGIN
	SELECT 'False' AS MSG;
	DECLARE @@MSG_WARNING VARCHAR(MAX) = 'MWP009 : '+ (SELECT dbo.GenerateMessage('MWP009','WORKING TYPE','',''));
...
@USERNAME,'','WP01006','1',1,'DELETE',@@COUNTER;