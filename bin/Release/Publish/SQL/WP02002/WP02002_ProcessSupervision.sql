...
BEGIN TRY
	...
	BEGIN
		...
		SET @@MSG_SUCCESS  = 'MWP003 : '+ (SELECT dbo.GenerateMessage('MWP003','IMPB SUPERVISION','',''));
	...
	BEGIN
		...
		SET @@MSG_SUCCESS = 'MWP001 : '+ (SELECT dbo.GenerateMessage('MWP001','IMPB SUPERVISION','',''));
...
BEGIN CATCH
	SET @@CHK = 'FALSE';
	SET @@ERR = 'ERROR INSERT TB_R_WP_DETAIL_SUPERVISION:' +@WP_PROJECT_JOB_ID+
