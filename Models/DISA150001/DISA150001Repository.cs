...
namespace AI070.Models.DISA150001Master
{
    ...
    public class DISA150001Detail
    {
        ...
        public int CAVITY_FILM { get; set; }
        public int CAVITY_GLASS { get; set; }
        public int CAVITY_TAIL { get; set; }
    ...
    {
        #region Get_Data_Grid_DISA150001
        public List<DISA150001_Transport_Master> getDataDISA150001(int Start, int Display, string ITEM_CODE, string JENIS_TRANSPORTATION, string TRANSPORTATION_COST)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        #region Count_Get_Data_Grid_DISA150001
        public int getCountDISA150001(string DATA_ID, string ITEM_CODE, string JENIS_TRANSPORTATION, string TRANSPORTATION_COST)
        {
        ...
        #region Add Data
        public static List<DISA150001_ListKonpo_Master> Create(
            string item_code,
            string lot_size,
            string master_qty,
            string box_qty,
        ...
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
            var d = db.Fetch<DISA150001_ListKonpo_Master>("DISA150001/Transport/DISA150001_Create", new
            {
                item_code,
                lot_size,
                master_qty,
        ...
        #region Update Data
        public List<DISA150001_ListKonpo_Master> Update_Data(
            string ID,
            string item_code,
            string lot_size,
            string master_qty,
        ...
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
            var d = db.Fetch<DISA150001_ListKonpo_Master>("DISA150001/Transport/DISA150001_Update", new
            {
                ID,
                item_code,
                lot_size,
