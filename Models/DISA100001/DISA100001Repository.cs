...
namespace AI070.Models.DISA100001Master
{
    ...
    public class DISA100001Repository
    {
        ...
        #region Get No_Urut
        public int getNo_Urutan(string TAHUN, string JENIS_ASSET, string KATEGORI_ASSET)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
            int result = db.SingleOrDefault<int>("DISA100001/DISA100001_getUrutan", new
            {
                TAHUN,
                JENIS_ASSET,
                KATEGORI_ASSET
        ...
        #region Get No_Asset
        public List<ListAssetModel> getListAsset()
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
            var d = db.Fetch<ListAssetModel>("DISA100001/DISA100001_getListAsset");
        ...
        public List<DISA100001Master> getDataAsset(int Start, int Display, string NO_ASSET, string NAMA_ASSET, string NAMA_FOTO, string MEREK, string SUPPLIER, string FLG_DISPOSE_ASSET)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        public int getCountDISA100001(string DATA_ID, string NO_ASSET, string NAMA_ASSET, string NAMA_FOTO, string MEREK, string SUPPLIER, string FLG_DISPOSE_ASSET)
        {
        ...
        public List<DISA100001Master> Qty_Amount_Asset(
            ...
            string MEREK, string SUPPLIER, string FLG_DISPOSE_ASSET, string JENIS_ASSET)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        public List<DISA10001_LIST_ASSET_DOWNLOAD> DownloadExcel_Asset(int PageNumber, int Display, string NO_ASSET, string NAMA_ASSET, string MEREK, string SUPPLIER, string FLG_DISPOSE_ASSET)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        public List<DISA10001_REQUEST_ASSET> getData_Request_Asset(int Start, int Display, string NO_REQUEST_ASSET, string NAMA_ASSET, string PIC_REQUEST, string DEPT_REQUEST, string ID_PR, string TGL_REQUEST, string TGL_PR)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        public int getCount_Request_Asset(string DATA_ID, string NO_REQUEST_ASSET, string NAMA_ASSET, string PIC_REQUEST, string DEPT_REQUEST, string ID_PR, string TGL_REQUEST, string TGL_PR)
        {
        ...
        public static List<DISA10001_REQUEST_ASSET_INPUT_FORM> Create_Detail_Request(DISA10001_REQUEST_ASSET_INPUT_FORM items, string NOMOR_URUT_REQUEST, string username, DateTime CREATED_DATE, string STATUS_REQUEST)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        public string Cancel_Data_Request_Asset(string ID)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        public List<DISA10001_AUDIT_ASSET> getDataAuditAsset(int Start, int Display, string NO_AUDIT, string NO_ASSET, string JENIS_AUDIT, string STATUS, string TAHUN, string PERIODE)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
        ...
        #region Count Data List Asset
        public int getCount_AuditAsset(string DATA_ID, string NO_AUDIT, string NO_ASSET, string JENIS_AUDIT, string STATUS, string TAHUN, string PERIODE)
        {
        ...
        public List<DISA10001_AUDIT_ASSET> Qty_Amount_Audit(string DATA_ID, string NO_AUDIT, string NO_ASSET, string JENIS_AUDIT, string STATUS, string TAHUN, string PERIODE, string JENIS_ASSET)
        {
            IDBContext db = DatabaseManager.Instance.GetContext("TxDTIPRD_10");
