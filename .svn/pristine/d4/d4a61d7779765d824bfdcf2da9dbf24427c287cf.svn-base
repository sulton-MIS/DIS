...
namespace AI070.Models.WP01006Master
{
    public class WP01006Repository
    {
        ...
        public List<WP01006Master> getDataWP01006(int Start, int Display, string AREA_CODE, string LOC_NAME)
        {
        ...
        public int getCountWP01006(string DATA_ID, string TIME_UNIT_CRITERIA, string EXECUTION_TIME, string STATUS_ACTIVE, string AREA_CODE, string LOC_NAME)
        {
        ...
        {
            IDBContext db = DatabaseManager.Instance.GetContext();
            var d = db.Execute("WP01006/WP01006_Delete", new
            {
                ID
            });
            db.Close();
        ...
        #region Update Data
        public List<WP01006> Update_Data(string ID, string COMPANY_NAME,string COMPANY_INITIAL,string EMAIL,string ADDRESS,string PHONE, string STATUS, string USERNAME)
        {
            IDBContext db = DatabaseManager.Instance.GetContext();
        ...
        public static List<WP01006> Create(string COMPANY_NAME, string COMPANY_INITIAL, string ADDRESS, string EMAIL, string PHONE, string STATUS, string USERNAME)
        {
            IDBContext db = DatabaseManager.Instance.GetContext();
