...
EXEC SP_INSERT_UPDATE_LOG_H @USERNAME,'','WP02002',1,'1','DELETE',@@COUNTER;
...
BEGIN TRY
	...
	DELETE TB_R_WP_DETAIL_IDENTIFICATION WHERE ID = @ID 

	DECLARE @@MSG_SUCCESS VARCHAR(MAX) = 'MWP002 : '+ (SELECT dbo.GenerateMessage('MWP002','DETAIL IDENTIFICATION','',''));
...
@USERNAME,'','WP02002','1',1,'DELETE',@@COUNTER;