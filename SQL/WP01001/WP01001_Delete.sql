...
EXEC SP_INSERT_UPDATE_LOG_H @USERNAME,'','WP01001',1,'1','DELETE',@@COUNTER;
...
BEGIN TRY
	...
	DELETE TB_M_SYSTEM WHERE SYSTEM_ID = @ID AND SYSTEM_TYPE = @SYSTEM_TYPE AND SYSTEM_CD = @CD
...
@USERNAME,'','WP01001','1',1,'DELETE',@@COUNTER;